...
const styles = StyleSheet.create({
  ...
  geoExceptionBody: { color: '#7F1D1D', fontSize: 13, lineHeight: 18 },
  notesCard: {
    backgroundColor: '#fff',
    borderRadius: 14,
    borderWidth: 1,
  ...
  startBtnText: { color: '#fff', fontWeight: '800', fontSize: 14, letterSpacing: 0.4 },
  cancelBtn: {
  ...
  cancelBtnText: { color: colors.secondary, fontWeight: '700', fontSize: 13 },
});
