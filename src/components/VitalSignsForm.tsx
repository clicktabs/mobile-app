  ...
  return (
    <Pressable onPress={() => onChange(!value)} style={[styles.checkRow, value && styles.checkRowOn]}>
      <Ionicons
        ...
        size={24}
        color={value ? '#2563EB' : colors.textMuted}
      />
...
const styles = StyleSheet.create({
  ...
  chipTextOn: { color: '#1D4ED8', fontWeight: '800' },
  addBtn: {
    alignSelf: 'stretch',
  ...
  checkLabel: { flex: 1, color: colors.text, fontSize: 15, lineHeight: 22, fontWeight: '500' },
  additionalBtn: {
  ...
  additionalBtnText: { color: '#fff', fontWeight: '800', fontSize: 15 },
  additionalTitle: {
    fontWeight: '800',
    color: '#1E3A8A',
    marginBottom: 4,
